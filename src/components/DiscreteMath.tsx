...
import books from "@/db/discrete-math/books.json";
import ytChannels from "@/db/discrete-math/ytChannels.json";
import websites from "@/db/discrete-math/websites.json";

export default function DiscreteMath() {
  return (
    <>
      <div className="flex flex-col gap-4">
        <SectionLayout title="Discrete Mathematics" />
