...
import books from "@/db/system-design/books.json";
import ytChannels from "@/db/system-design/ytChannels.json";
import websites from "@/db/system-design/websites.json";

export default function SystemDesign() {
  return (
    <>
      <div className="flex flex-col gap-4">
        <SectionLayout title="System Design" />
