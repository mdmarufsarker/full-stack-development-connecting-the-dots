...
import books from "@/db/react-redux/books.json";
import ytChannels from "@/db/react-redux/ytChannels.json";
import websites from "@/db/react-redux/websites.json";

export default function ReactRedux() {
  return (
    <>
      <div className="flex flex-col gap-4">
        <SectionLayout title="React Redux" />
