...
import books from "@/db/uiux/books.json";
import ytChannels from "@/db/uiux/ytChannels.json";
import websites from "@/db/uiux/websites.json";

export default function UIUX() {
  return (
    <>
      <div className="flex flex-col gap-4">
        <SectionLayout title="UI / UX Design" />
