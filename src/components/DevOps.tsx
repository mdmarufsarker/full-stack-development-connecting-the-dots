...
import books from "@/db/devops/books.json";
import ytChannels from "@/db/devops/ytChannels.json";
import websites from "@/db/devops/websites.json";

export default function DevOps() {
  return (
    <>
      <div className="flex flex-col gap-4">
        <SectionLayout title="DevOps" />
