...
import books from "@/db/java/books.json";
import ytChannels from "@/db/java/ytChannels.json";
import websites from "@/db/java/websites.json";

export default function Java() {
  return (
    <>
      <div className="flex flex-col gap-4">
        <SectionLayout title="Java Programming" />
